...
import { Phone, MessageCircle, Instagram, Twitter, BookOpen, Github } from 'lucide-react';
...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: <Phone size={24} />,
      label: "Backup Number",
      value: "+256 790 739 106",
      href: "tel:+256790739106"
    }
  ];
  ...
  const socialLinks = [
    ...
    {
  icon: <BookOpen size={20} />, // Or <MediumIcon /> if you have a custom svg
  name: "Medium",
  handle: "@abaasabyoona1",
  href: "https://medium.com/@abaasabyoona1",
