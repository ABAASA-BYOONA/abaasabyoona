...
const projects = [
  {
    title: "Vegus Ink",
    description: "Artistic studio platform showcasing precision craft. From intricate fine-line tattoos to elegant piercings, we bring your vision to life with precision and artistry.",
    tech: ["React", "Art & Design", "UI/UX", "Portfolio"],
    link: "https://vegusink.vercel.app/",
  ...
  {
    title: "The Betting God",
    description: "🚧 Currently under production. A premium sports analytics mobile application delivering expert tips across football and basketball, curated by professional analysts.",
    tech: ["React Native", "Firebase", "Sports API", "Analytics"],
    link: "#", 
    gradient: "linear-gradient(135deg, #bf953f, #fcf6ba, #b38728)", 
    icon: "⚡", 
    type: "mobile",
    status: "In Development" // Added for conditional rendering if your UI supports it
},
  {
    title: "Shoppie UG",
